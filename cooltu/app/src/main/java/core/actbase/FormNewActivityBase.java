...
public abstract class FormNewActivityBase extends com.codingtu.cooltu.ui.base.BaseActivity implements View.OnClickListener, View.OnLongClickListener, com.codingtu.cooltu.lib4a.net.netback.NetBackI{
    ...
    protected void initBindView() {
        ...
        numLlRg = com.codingtu.cooltu.lib4a.view.combine.RadioGroup.obtain(this).setBts(numLl).setOnSetItem(typeOnSetItem).initItems().setOnClick((index, view) -> infoBindConfig.onNumLlOnClick(info, index, view, numLl));
        numLl.setTag(com.codingtu.cooltu.lib4a.R.id.tag_0, numLlRg);
        num2LlRg = com.codingtu.cooltu.lib4a.view.combine.RadioGroup.obtain(this).setBts(num2Ll).setOnSetItem(typeOnSetItem).setItems("1", "2", "3");
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                ...
                case com.codingtu.cooltu.R.id.numLl:
                    info.num = com.codingtu.cooltu.lib4a.tools.ViewTool.getRadioGroupItem((android.view.ViewGroup) linkObjs.get(0), (int) msg.obj);
                    break;
                case com.codingtu.cooltu.R.id.num2Ll:
                    info.num = com.codingtu.cooltu.lib4a.tools.ViewTool.getRadioGroupItem((android.view.ViewGroup) linkObjs.get(0), (int) msg.obj);
                    break;
                case com.codingtu.cooltu.R.id.num1Ll:
                    info.num1 = (int) msg.obj;
                    break;
