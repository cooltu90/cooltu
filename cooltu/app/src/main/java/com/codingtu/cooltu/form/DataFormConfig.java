...
public class DataFormConfig {
    ...
    public FormDatas.FormData checkName(FormDatas.FormData formData, EditText nameEt) {
    ...
    public FormDatas.FormData checkNum(FormDatas.FormData formData, LinearLayout numLl) {
        return formData;
    }
