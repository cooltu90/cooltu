package cooltu.processor.worker.model.mock;
...
import cooltu.processor.modelinterface.MockModelInterface;
...
public class MockModel extends SingleCoreToolsBaseModel implements MockModelInterface {
    ...
    public void add(ExecutableElement element) {
        ...
        String name = NameTools.toStaticType(actName) + "_" + NameTools.toStaticType(methodName);
