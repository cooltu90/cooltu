...
import cooltu.processor.modelinterface.StartModelInterface;
...
//        Ls.ls(METHODS_MAP, new MapEach<String, ListValueMap<Integer, KV<String, String>>>() {
//            @Override
...
//                    addModel(sb, new StartMethodModel(actFullName, actStaticName));
//                } else {
//                    Ls.ls(ikv, new MapEach<Integer, List<KV<String, String>>>() {
//                        @Override
//                        public boolean each(int position, Integer integer, List<KV<String, String>> kvs) {
//                            addModel(sb, new StartMethodModel(actFullName, actStaticName, kvs));
//                            return false;
