...
import cooltu.processor.modelinterface.PassModelInterface;
        ...
        Ts.ls(kvs, new Each<KV<String, String>>() {
            ...
            public boolean each(int position, KV<String, String> kv) {
                ...
                addLnTag(fieldsSb,
                        ...
                        NameTools.toStaticType(kv.v), kv.v);
                return false;
            }
        });
    }
    ...
    public void setTagFor_methods(StringBuilder methodsSb) {
        Ts.ls(kvs, new Each<KV<String, String>>() {
            ...
            public boolean each(int position, KV<String, String> kv) {
                ...
                String staticName = NameTools.toStaticType(name);
                String methodName = NameTools.toMethodType(name);
