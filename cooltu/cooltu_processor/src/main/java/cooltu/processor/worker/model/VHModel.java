...
import cooltu.processor.modelinterface.VHModelInterface;
...
public class VHModel extends BaseModel implements VHModelInterface {
    ...
    public VHModel(JavaInfo info, String typeBaseName, boolean isForce) {
        super(info);
        layoutName = NameTools.getItemLayoutName(NameTools.toLayoutType(typeBaseName));
        layoutId = new IdTools.Id(Constant.PKG_DEFAULT_R, Constant.R_TYPE_LAYOUT, layoutName);
