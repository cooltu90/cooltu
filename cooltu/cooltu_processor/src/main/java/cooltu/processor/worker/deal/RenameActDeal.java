...
public class RenameActDeal extends BaseDeal {
    ...
    public void deal(Element element) {
        ...
        JavaInfo oldActJi = NameTools.getJavaInfoByName(oldPackages, oldName, Constant.SUFFIX_ACTIVITY);
        Constant.RENAME_ACTS.add(oldActJi.fullName);
        JavaInfo newActJi = NameTools.getJavaInfoByName(newPackages, newName, Constant.SUFFIX_ACTIVITY);
        ...
        FileLineDealer.create(oldFile).deal(new FileLineDealer.Dealer() {
            ...
            public String deal(String line) {
                ...
                if (line.contains(Constant.PKG_R_LAYOUT + oldLayout)) {
                    line = line.replace(Constant.PKG_R_LAYOUT + oldLayout, Constant.PKG_R_LAYOUT + newLayout);
                }
