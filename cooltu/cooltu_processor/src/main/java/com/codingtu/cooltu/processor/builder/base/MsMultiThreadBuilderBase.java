...
public abstract class MsMultiThreadBuilderBase extends com.codingtu.cooltu.processor.builder.core.CoreBuilder {
    ...
    public MsMultiThreadBuilderBase(com.codingtu.cooltu.lib4j.data.java.JavaInfo info) {
        super(info);
        pkg = map.get("pkg");
        name = map.get("name");
