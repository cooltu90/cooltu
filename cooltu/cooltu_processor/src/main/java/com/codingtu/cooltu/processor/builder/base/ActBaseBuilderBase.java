...
public abstract class ActBaseBuilderBase extends com.codingtu.cooltu.processor.builder.core.CoreBuilder {
    ...
    protected java.util.Map<String, Boolean> formMethodsIfs;
    protected java.util.Map<String, Integer> formMethodsCounts;
    protected StringBuilder formMethodsSb;
    protected com.codingtu.cooltu.lib4j.data.map.ListValueMap<String, String> formMethods;
    ...
    public ActBaseBuilderBase(com.codingtu.cooltu.lib4j.data.java.JavaInfo info) {
        ...
        formMethodsIfs = new java.util.HashMap<>();
        formMethodsCounts = new java.util.HashMap<>();
        formMethodsSb = map.get("formMethods");
        formMethods = new com.codingtu.cooltu.lib4j.data.map.ListValueMap<>();
    ...
    public void formInitIf(String formInit) {
        addForMap(this.formInit, getIfKey("formInit"), formInit);
    ...
    public void formMethodsIf(String formMethods) {
        addForMap(this.formMethods, getIfKey("formMethods"), formMethods);
        formMethodsIfs.put(getIfKey("formMethods"), true);
    }
    ...
    protected void dealLinesInParent() {
        ...
        if (isIf(formInitIfs, getIfKey("formInit"))) {
            ...
            addLnTag(formInitSb, "[formInit]", formInit0.get(0));
        }
        ...
        if (isIf(formMethodsIfs, getIfKey("formMethods"))) {
            List<String> formMethods0 = formMethods.get(getIfKey("formMethods"));
            addLnTag(formMethodsSb, "[formMethods]", formMethods0.get(0));
        }
